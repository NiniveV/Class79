...
function submit()
{
    ...
    name_of_the_name_array.push(name_1);
    name_of_the_name_array.push(name_2);
    name_of_the_name_array.push(name_3);
    name_of_the_name_array.push(name_4);
...
function sorting()
{
    name_of_the_student_arrey.sort();
    console.log(name_of_the_student_array);
